...
Local change can be influenced pretty dramatically with relatively few people. While it might sound obvious, local politicians are often elected by slim margins with relatively few overall votes, sometimes only hundreds of votes. 
...
So, let's say you want something to change locally. Maybe an ordinance, or you want to improve the playground, or you want some flashing lights for your crosswalk to keep your kids safe. How do you get people to tell politicians that they want something?
...
- They are hyper-local, can be put right where the problem exists (and therefore motivation)
- Can load an email template right from a person's phone
- Can load the email addresses that you want it sent to
...
- Write your email in a Google Doc. Proofread it. Get a friend or loved one to look it over. Send it to yourself. Make sure it's really tight, clearly lays out the problem you want solved, and your expectation that they solve it. 
- Find your local politicians email addresses. If the police would be useful, find the police chief's email. Consider whether or not the county has jurisdiction. 
- Create a custom email to track who sends them, like localhelper@gmail.com
- Take the contents of the email, and the email addresses you collected, and paste it into the to:, subject, and message fields of this tool and generate a mailto: https://mailtolinkgenerator.com/ - make sure to include your helper email in the to: field so you can track who actually sends the email (this is important to know if what you're doing is working, if you need to adjust messaging, etc)
- Generate a tinyurl and QRCode by pasting the contents of the mailto into the long url field: https://tinyurl.com/
- Create a flyer, you can use [this Google Doc](https://docs.google.com/document/d/1WPaE5VnOFAi5K_PcxBEdQokpOVXawGHriMXYsAh-nIs/edit?tab=t.0) as a template
- Print it out and test it. Hold your phone up, send an email. Make sure it looks good. 
- Hang them up!

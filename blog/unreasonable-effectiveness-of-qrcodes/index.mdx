...
- They are hyper-local, can be put right where the problem exists (and therefore drive motivation)
...
- Write your email in a Google Doc. Proofread it. Get a friend or loved one to look it over. Send it to yourself. Make sure there's no grammar issues, clearly lays out the problem you want solved, and your expectation that they solve it. 

...
featured-image: "./badger-main-image.png"
callout-image: "./badger-logomark-whiteborder-square--large.png"
...
![Here is the desktop view broken down into it's main structural components.](./badger-webapp-desktop-wireframe.png)

![And this is what the desktop version looks like fully designed](./badger-webapp-desktop-current.png)
...
![The wireframe broke down the app design structure into three main states: Base, Menu Selected, and Detail. Detail is only triggered when an item inside a selected-menu view needed to expand to another view.](./badger-webapp-mobile-metaphor-wireframe.png)

![And now the mobile structure in practice](./badger-webapp-mobile-metaphor.png)
...
![The routes base-state invites you to get going and provides an insanely simple point-of-entry: a single button](./badger-webapp-routes.png)

![Tapping the button reveals a simple popover-like interface that is easy to quickly select accounts from](./badger-webapp-route-add.png)

![Once the route is filled, you are presented with many more options like adjusting the duration, time, and stop-order of the route.](./badger-webapp-route-filled.png)
...
![](./badger-webapp-desktop-early.png)Early designs were meant to rapidly expose features and didn't yet have a strong sense of organization or structure

![](./badger-webapp-desktop-middle.png)As time permitted, we went back to the original and made it more usable on tablets by increasing touch targets. Time was also taken to solidify the design around brand colors and make the app feel more cohesive.

![](./badger-webapp-desktop-current.png)When the limits of the original design were reached, I went back to the drawing board and redesigned the app around a 'pane' metaphor, with a menu state on the left and a detail state on the right. This allowed the map to stay front and center.
...
![](./badger-ios-screens.png)The most consequential screens on iOS
...
![Our route creation screen feels a bit complicated, and includes a lot of information that's unnecessary once you are actually executing your day](./badger-ios-route-list.png)
...
![](./badger-ios-route-mode.png)Once you're in route mode, everything else melts away
...
![](./badger-ios-transition.png)Our iOS app through the sands of time (or iOS versions, if you will)
...
![](./badger-android-screens.png)Our primary Android screens
...
![](./badger-ios-android-difference-account-detail.png)Differences between the account detail screens

![](./badger-ios-android-difference-accounts.png)Differences between the account list screens

![](./badger-ios-android-difference-route.png)Differences between the route list screens
...
![](./badger-logo-before-after.png)Thicker lines reduce better, curves flow in harmony, logo overall feels more 'designed'.

![](./badger-logo-before-after-with-points.png)Point reduction, simplification, and consistency makes for a technically easier to work with product.

![](./badger-logo-three-styles-before.png)Original versions highlighting problems when going black and white

![](./badger-logo-three-styles-after.png)Improvements in being able to go black and white
